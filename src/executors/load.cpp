...
void executeMatrixLOAD()
{
    ...
    // Debugging output
    cout << "Parsed relation name: '" << parsedQuery.loadRelationName << "'" << endl;
    ...
    if (matrix->load())
    {
        // cout << "hello" << endl;
        matrixCatalogue.insertMatrix(matrix);
        cout << "Loaded Table. Column Count: " << matrix->columnCount 
