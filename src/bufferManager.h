...
class BufferManager{
    ...
    Page insertIntoPool(string matrixName,int rowNumberOfPage , int columnNumberOfPage);

    public:
    
    BufferManager();
    Page getPage(string tableName, int pageIndex);
    Page getPage(string matrixName,int rowNumberOfPage , int columnNumberOfPage);
